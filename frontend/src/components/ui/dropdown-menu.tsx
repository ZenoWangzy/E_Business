 ...
 * Radix-based dropdown menu primitives.
 *
 * [INPUT]:
 * - Props: Radix DropdownMenu primitive props
 *
 * [LINK]:
 * - Utils -> @/lib/utils (cn)
 * - Radix -> @radix-ui/react-dropdown-menu
 *
 * [OUTPUT]: DropdownMenu components
 * [POS]: /frontend/src/components/ui/dropdown-menu.tsx
 *
 * [PROTOCOL]:
 * 1. Must forward refs for Radix components.
 * 2. Pure UI primitives; no business logic.
 *
 * === END HEADER ===
 */
